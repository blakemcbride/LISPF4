(OR (GETD 'MATCH) (READFILE "match.lisp") (PRINT "match.lisp IS NEEDED HERE AND COULD NOT BE LOADED"))
(OR (GETD 'DO) (READFILE "ifdo.lisp") (PRINT "ifdo.lisp IS NEEDED HERE AND COULD NOT BE LOADED"))
(FILEHEADER PRINTA)
